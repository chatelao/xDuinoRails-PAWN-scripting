...
Blockly.Blocks['pawn_on_function_change'] = {
  init: function() {
    this.appendDummyInput()
        .appendField("onFunctionChange(id, value)");
    this.appendStatementInput("STACK")
        .setCheck(null);
    this.setColour(230);
    this.setTooltip("Event triggered when a function state changes");
    this.setHelpUrl("");
  }
};
...
Blockly.Blocks['pawn_actual_speed'] = {
  init: function() {
    ...
    this.setOutput(true, "Number");
    this.setColour(160);
    this.setTooltip("Returns the actual speed via Railcom");
    this.setHelpUrl("");
  }
};
...
Blockly.Blocks['pawn_load'] = {
  init: function() {
    ...
    this.setOutput(true, "Number");
    this.setColour(160);
    this.setTooltip("Returns the current load via Railcom");
    this.setHelpUrl("");
  }
};
...
Blockly.Blocks['pawn_temperature'] = {
  init: function() {
    ...
    this.setOutput(true, "Number");
    this.setColour(160);
    this.setTooltip("Returns the current temperature via Railcom");
    this.setHelpUrl("");
  }
};
...
Blockly.Blocks['pawn_voltage'] = {
  init: function() {
    ...
    this.setOutput(true, "Number");
    this.setColour(160);
    this.setTooltip("Returns the current voltage via Railcom");
    this.setHelpUrl("");
  }
};
...
Blockly.Blocks['pawn_get_function'] = {
  init: function() {
    ...
    this.setOutput(true, "Number");
    this.setColour(160);
    this.setTooltip("Returns the state of a given function ID");
    this.setHelpUrl("");
  }
};
...
Blockly.Blocks['pawn_set_output'] = {
  init: function() {
    ...
    this.setColour(160);
    this.setTooltip("Sets the state of a given output ID");
    this.setHelpUrl("");
  }
};
...
PawnGenerator.forBlock['pawn_on_function_change'] = function(block) {
  const stack = PawnGenerator.statementToCode(block, 'STACK');
  return 'public onFunctionChange(id, value) {\n' + stack + '}\n';
};
...
function generateBlocksFromCode(code) {
    ...
    const functions = [
        ...
        { name: 'onFunctionChange', block: 'pawn_on_function_change' }
    ];
...
function parseStatements(code, connection) {
    ...
    while (remaining.length > 0) {
        ...
        // set_output(id, state)
        else if (match = remaining.match(/^set_output\((\d+)\s*,\s*(\d+)\);/)) {
            ...
            block.setFieldValue(match[2], 'STATE');
            block.initSvg();
            block.render();
            currentConnection.connect(block.previousConnection);
            currentConnection = block.nextConnection;
