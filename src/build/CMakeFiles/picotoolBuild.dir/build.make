...
CMakeFiles/picotoolBuild-complete: picotool/src/picotoolBuild-stamp/picotoolBuild-test
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'picotoolBuild'"
	/usr/bin/cmake -E make_directory /app/src/build/CMakeFiles
	/usr/bin/cmake -E touch /app/src/build/CMakeFiles/picotoolBuild-complete
	/usr/bin/cmake -E touch /app/src/build/picotool/src/picotoolBuild-stamp/picotoolBuild-done
...
picotool/src/picotoolBuild-stamp/picotoolBuild-build: picotool/src/picotoolBuild-stamp/picotoolBuild-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Performing build step for 'picotoolBuild'"
	cd /app/src/build/_deps/picotool-build && $(MAKE)
...
picotool/src/picotoolBuild-stamp/picotoolBuild-configure: picotool/src/picotoolBuild-stamp/picotoolBuild-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "Performing configure step for 'picotoolBuild'"
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake --no-warn-unused-cli -DCMAKE_MAKE_PROGRAM:FILEPATH=/usr/bin/gmake -DPICO_SDK_PATH:FILEPATH=/home/jules/pico-sdk -DPICOTOOL_NO_LIBUSB=1 -DPICOTOOL_FLAT_INSTALL=1 -DCMAKE_INSTALL_PREFIX=/app/src/build/_deps -DCMAKE_RULE_MESSAGES=OFF -DCMAKE_INSTALL_MESSAGE=NEVER "-GUnix Makefiles" -S /app/src/build/_deps/picotool-src -B /app/src/build/_deps/picotool-build
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake -E touch /app/src/build/picotool/src/picotoolBuild-stamp/picotoolBuild-configure
...
picotool/src/picotoolBuild-stamp/picotoolBuild-download: picotool/src/picotoolBuild-stamp/picotoolBuild-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "No download step for 'picotoolBuild'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/src/build/picotool/src/picotoolBuild-stamp/picotoolBuild-download

picotool/src/picotoolBuild-stamp/picotoolBuild-install: picotool/src/picotoolBuild-stamp/picotoolBuild-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "Performing install step for 'picotoolBuild'"
	cd /app/src/build/_deps/picotool-build && $(MAKE) install

picotool/src/picotoolBuild-stamp/picotoolBuild-build:
.PHONY : picotool/src/picotoolBuild-stamp/picotoolBuild-build

picotool/src/picotoolBuild-stamp/picotoolBuild-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'picotoolBuild'"
	/usr/bin/cmake -Dcfgdir= -P /app/src/build/picotool/tmp/picotoolBuild-mkdirs.cmake
	/usr/bin/cmake -E touch /app/src/build/picotool/src/picotoolBuild-stamp/picotoolBuild-mkdir
...
picotool/src/picotoolBuild-stamp/picotoolBuild-patch: picotool/src/picotoolBuild-stamp/picotoolBuild-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'picotoolBuild'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/src/build/picotool/src/picotoolBuild-stamp/picotoolBuild-patch

picotool/src/picotoolBuild-stamp/picotoolBuild-test: picotool/src/picotoolBuild-stamp/picotoolBuild-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "Performing test step for 'picotoolBuild'"
	cd /app/src/build/_deps/picotool-build && /app/src/build/_deps/picotool/picotool version 2.1.1
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake -E touch /app/src/build/picotool/src/picotoolBuild-stamp/picotoolBuild-test
...
picotool/src/picotoolBuild-stamp/picotoolBuild-update: picotool/src/picotoolBuild-stamp/picotoolBuild-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "No update step for 'picotoolBuild'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/src/build/picotool/src/picotoolBuild-stamp/picotoolBuild-update
...
CMakeFiles/picotoolBuild.dir/depend:
	cd /app/src/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /app/src /app/src /app/src/build /app/src/build /app/src/build/CMakeFiles/picotoolBuild.dir/DependInfo.cmake "--color=$(COLOR)"
