...
CMAKE_SOURCE_DIR = /app/src/build/_deps/picotool-subbuild

# The top-level build directory on which CMake was run.
CMAKE_BINARY_DIR = /app/src/build/_deps/picotool-subbuild
...
CMakeFiles/picotool-populate-complete: picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-test
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/_deps/picotool-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Completed 'picotool-populate'"
	/usr/bin/cmake -E make_directory /app/src/build/_deps/picotool-subbuild/CMakeFiles
	/usr/bin/cmake -E touch /app/src/build/_deps/picotool-subbuild/CMakeFiles/picotool-populate-complete
	/usr/bin/cmake -E touch /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-done
...
picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-build: picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-configure
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/_deps/picotool-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "No build step for 'picotool-populate'"
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake -E echo_append
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake -E touch /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-build
...
picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-configure: picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-patch
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/_deps/picotool-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_3) "No configure step for 'picotool-populate'"
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake -E echo_append
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake -E touch /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-configure
...
picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-download: picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-mkdir
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/_deps/picotool-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_4) "Performing download step (git clone) for 'picotool-populate'"
	cd /app/src/build/_deps && /usr/bin/cmake -P /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/tmp/picotool-populate-gitclone.cmake
	cd /app/src/build/_deps && /usr/bin/cmake -E touch /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-download
...
picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-install: picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-build
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/_deps/picotool-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_5) "No install step for 'picotool-populate'"
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake -E echo_append
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake -E touch /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-install

picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-mkdir:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/_deps/picotool-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_6) "Creating directories for 'picotool-populate'"
	/usr/bin/cmake -Dcfgdir= -P /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/tmp/picotool-populate-mkdirs.cmake
	/usr/bin/cmake -E touch /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-mkdir
...
picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-patch: picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-update
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/_deps/picotool-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_7) "No patch step for 'picotool-populate'"
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-patch
...
picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-test: picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-install
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/_deps/picotool-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_8) "No test step for 'picotool-populate'"
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake -E echo_append
	cd /app/src/build/_deps/picotool-build && /usr/bin/cmake -E touch /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-test
...
picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-update: picotool-populate-prefix/src/picotool-populate-stamp/picotool-populate-download
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/app/src/build/_deps/picotool-subbuild/CMakeFiles --progress-num=$(CMAKE_PROGRESS_9) "Performing update step for 'picotool-populate'"
	cd /app/src/build/_deps/picotool-src && /usr/bin/cmake -Dcan_fetch=YES -P /app/src/build/_deps/picotool-subbuild/picotool-populate-prefix/tmp/picotool-populate-gitupdate.cmake
...
CMakeFiles/picotool-populate.dir/depend:
	cd /app/src/build/_deps/picotool-subbuild && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /app/src/build/_deps/picotool-subbuild /app/src/build/_deps/picotool-subbuild /app/src/build/_deps/picotool-subbuild /app/src/build/_deps/picotool-subbuild /app/src/build/_deps/picotool-subbuild/CMakeFiles/picotool-populate.dir/DependInfo.cmake "--color=$(COLOR)"
