...
CMakeFiles/enc_bootloader-complete: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-install
	...
	/usr/bin/cmake -E touch /app/src/build/_deps/picotool-build/CMakeFiles/enc_bootloader-complete
	/usr/bin/cmake -E touch /app/src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-done
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-build: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure
	cd /app/src/build/_deps/picotool-build/enc_bootloader && $(MAKE)
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch
	cd /app/src/build/_deps/picotool-build/enc_bootloader && /usr/bin/cmake -DCMAKE_MAKE_PROGRAM:FILEPATH=/usr/bin/gmake -DPICO_SDK_PATH:FILEPATH=/home/jules/pico-sdk -DUSE_PRECOMPILED:BOOL=true -DUSE_MBEDTLS=0 -DPICO_DEBUG_INFO_IN_RELEASE=OFF "-GUnix Makefiles" -S /app/src/build/_deps/picotool-src/enc_bootloader -B /app/src/build/_deps/picotool-build/enc_bootloader
	cd /app/src/build/_deps/picotool-build/enc_bootloader && /usr/bin/cmake -E touch /app/src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-configure
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir
	...
	/usr/bin/cmake -E touch /app/src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-install: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-build
	cd /app/src/build/_deps/picotool-build/enc_bootloader && /usr/bin/cmake -E echo_append

enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir:
	/usr/bin/cmake -Dcfgdir= -P /app/src/build/_deps/picotool-build/enc_bootloader/tmp/enc_bootloader-mkdirs.cmake
	/usr/bin/cmake -E touch /app/src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-mkdir
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-patch
...
enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update: enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-download
	/usr/bin/cmake -E echo_append
	/usr/bin/cmake -E touch /app/src/build/_deps/picotool-build/enc_bootloader/src/enc_bootloader-stamp/enc_bootloader-update
